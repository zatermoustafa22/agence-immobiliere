...
.button:hover {
  background-color: #0056b3;
    ...
    <script>
    // Get the input and group elements
...
>
  ...
  />
    ...
    <div class="hero">
        ...
        <div class="banner">
        <h2>C'est le moment pour déposer </h2>
    ...
    if ($result && $result->num_rows > 0):
        while ($row = $result->fetch_assoc()):
            ...
            ?>
            <div class="property-card" onclick="window.location.href='afficher_propriete.php'" style="cursor: pointer;">
